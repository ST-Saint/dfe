...
class ProbeInserter extends MethodVisitor implements IProbeInserter {
    ...
    ProbeInserter(final int access, final String name, final String desc, final MethodVisitor mv,
        ...
        this.clinit = DfeProperty.CLINIT_NAME.equals(name);
    ...
    public final void visitLocalVariable(final String name, final String desc, final String signature,
        ...
        if (index < variable) {
            ...
            mv.visitLocalVariable(name, desc, signature, beginLabel, end, index);
        } else {
    ...
    public AnnotationVisitor visitLocalVariableAnnotation(final int typeRef, final TypePath typePath,
        ...
        return mv.visitLocalVariableAnnotation(typeRef, typePath, start, end, newIndex, descriptor, visible);
    }
    ...
    public final void visitFrame(final int type, final int nLocal, final Object[] local, final int nStack,
        ...
        while (idx < nLocal || pos <= variable) {
            if (pos == variable) {
                newLocal[newIdx++] = InstructionClassAdapter.probeDesc;
                pos++;
            } else {
                if (idx < nLocal) {
