...
public class Instance {
    ...
    private static boolean[] getBooleans() {
        ...
        Object[] obzzz = new Object[] { 5711681868228170062L, "edu/purdue/dfe/TestSample", 15 };
    ...
    //         }
    //     };
    //     InstructionClassAdapter ica = new InstructionClassAdapter(writer, "class", 0x11L);
    //     reader.accept(ica, 0);
    ...
    //     // IExecutionDataAccessorGenerator accessorGenerator = new InjectedClassRuntime(Object.class, "$JaCoCo");
    //     IExecutionDataAccessorGenerator accessorGenerator = new ModifiedSystemClassRuntime(Instance.class, "$jacocoAccess");
