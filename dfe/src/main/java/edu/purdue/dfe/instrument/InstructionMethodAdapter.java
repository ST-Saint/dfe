...
public class InstructionMethodAdapter extends MethodVisitor implements Opcodes {
	...
	public InstructionMethodAdapter(MethodVisitor mv, ClassVisitor cv,
			String className, String methodName, String desc, String signature,
			String[] exceptions) {
	...
	// @Override
	// public void visitLookupSwitchInsnWithProbes(final Label dflt, final int[]
	// keys, final Label[] labels,
	// final IFrame frame) {
	// // 1. Calculate intermediate labels:
	// LabelInfo.resetDone(dflt);
	// LabelInfo.resetDone(labels);
	...
	// private void insertIntermediateProbe(final Label label, final IFrame
	// frame) {
	...
	// private void insertIntermediateProbes(final Label dflt, final Label[]
	// labels, final IFrame frame) {
	// LabelInfo.resetDone(dflt);
	// LabelInfo.resetDone(labels);
